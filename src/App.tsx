...
function MasteryGlobe({ glow, credits, total }: { glow: number; credits: number; total: number }) {
  ...
  return (
    <section className="rounded-[2rem] border border-academy-line bg-white p-6 shadow-institutional">
      ...
      >
        <motion.div className="absolute inset-5 rounded-full border border-white/20" style={{ opacity: springGlow.to((value) => 0.18 + value / 140) }} />
        <motion.div className="absolute h-44 w-44 rounded-full bg-academy-cyan blur-3xl" style={{ opacity: springGlow.to((value) => value / 140) }} />
